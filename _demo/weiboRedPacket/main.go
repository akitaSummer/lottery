// 压力测试 wrk -t10 -c10 -d5 "http://localhost:8080/set?uid=1&money=100&num100"
package main
...
// curl "http://localhost:8080/get?id=1680038017&uid=1&num=100"
...
func (c *lotteryController) GetGet() string {
	...
	t := task{id: uint32(32), callback: callback}
	// 发送任务
